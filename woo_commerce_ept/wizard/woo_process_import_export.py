...
class woo_process_import_export(models.TransientModel):
    ...
    def sync_products(self):
        ...
        for instance in self.instance_ids:
            if instance.woo_version == 'old':
                woo_template_obj.sync_products(instance,update_price=instance.sync_price_with_product,sync_images_with_product=instance.sync_images_with_product)
            elif instance.woo_version == 'new':
                woo_template_obj.sync_new_products(instance,update_price=instance.sync_price_with_product,sync_images_with_product=instance.sync_images_with_product)
        return True
